...
class AppLocalizationsRu extends AppLocalizations {
  ...
  String get mobileAccountPreferencesHelp =>
      'Эти настройки применяются к вашему аккаунту Lichess и будут использоваться на всех устройствах.';
  ...
  String get mobileCancelTakebackOffer =>
      'Отменить предложение о возврате хода';
  ...
  String get mobileNotFollowingAnyUser =>
      'Вы не подписаны на других пользователей.';
  ...
  String get mobilePrefMagnifyDraggedPiece =>
      'Увеличивать перетаскиваемую фигуру';

  @override
  String get mobilePuzzleStormConfirmEndRun =>
      'Вы хотите завершить эту попытку?';
  ...
  String get mobilePuzzleStormNothingToShow =>
      'Нечего показать. Сыграйте несколько раз.';

  @override
  String get mobilePuzzleStormSubtitle =>
      'Решите как можно больше задач за 3 минуты.';
  ...
  String get mobileWelcomeToLichessApp =>
      'Добро пожаловать в приложение Lichess!';
  ...
  String get mobileOpeningExplorerNotAvailableOffline =>
      'Книга дебютов недоступна офлайн.';
  ...
  String get variantChess960Title =>
      'Стартовая позиция фигур определяется случайно.';
  ...
  String get variantKingOfTheHillTitle =>
      'Проведите короля в центр доски, чтобы выиграть партию.';
  ...
  String get variantAtomicTitle =>
      'Взорвите короля противника, чтобы победить.';
  ...
  String get variantFromPositionTitle =>
      'Стандартные шахматы с заданной позиции';
  ...
  String activityRankedInTournament(
    ...
    String _temp0 = intl.Intl.pluralLogic(
      ...
      locale: localeName,
      other:
          '$count место ($param2 % лучших), по результатам $param3 игр в турнире $param4',
      many:
          '$count место ($param2 % лучших), по результатам $param3 игр в турнире $param4',
      few:
          '$count место ($param2 % лучших), по результатам $param3 игр в турнире $param4',
      one:
          '$count место ($param2 % лучших), по результатам $param3 игры в турнире $param4',
    );
    return '$_temp0';
  }
  ...
  String get arenaIsRated =>
      'Это рейтинговый турнир, каждая игра в нём повлияет на ваш рейтинг.';

  @override
  String get arenaIsNotRated =>
      'Это товарищеский турнир, игра в нём не повлияет на ваш рейтинг.';
  ...
  String get broadcastHowToUseLichessBroadcasts =>
      'Как пользоваться трансляциями Lichess.';
  ...
  String get broadcastDefinitivelyDeleteRound =>
      'Определенно удалить тур и его партии.';
  ...
  String get broadcastAllBroadcastsByMonth =>
      'Просмотр всех трансляций за месяц';
  ...
  String get challengeDeclineCasual =>
      'Вызовите меня на товарищескую игру, пожалуйста.';
  ...
  String get challengeDeclineVariant =>
      'Прямо сейчас я не хочу играть этот вариант.';
  ...
  String get challengeInviteLichessUser =>
      'Или пригласите пользователя Lichess:';
  ...
  String get preferencesWhenTimeRemainingLessThanTenSeconds =>
      'Когда остаётся меньше 10 секунд';

  @override
  String get preferencesHorizontalGreenProgressBars =>
      'Убывающий зелёный индикатор';
  ...
  String get preferencesTakebacksWithOpponentApproval =>
      'Возвраты (с согласия противника)';
  ...
  String get preferencesWhenTimeRemainingLessThanThirtySeconds =>
      'Когда остаётся меньше 30 секунд';
  ...
  String get preferencesCorrespondenceAndUnlimited =>
      'По переписке и без ограничения времени';
  ...
  String get preferencesNotifyForumMention =>
      'Вас упомянули в сообщении на форуме';
  ...
  String get preferencesNotifyGameEvent =>
      'Обновления, касающиеся игры по переписке';
  ...
  String get preferencesNotifyBroadcasts =>
      'Трансляции, на которые вы подписаны';

  @override
  String get preferencesNotifyTimeAlarm =>
      'В игре по переписке скоро упадёт флажок';
  ...
  String get preferencesShowClockOnTheLeft =>
      'Показывать слева на мобильных устройствах';
  ...
  String get puzzleToGetPersonalizedPuzzles =>
      'Чтобы получить персонализированные задачи:';
  ...
  String get puzzleUseCtrlF =>
      'Используйте Ctrl+f, чтобы найти ваш любимый дебют!';
  ...
  String get puzzleJumpToNextPuzzleImmediately =>
      'Сразу переходить к следующей задаче';
  ...
  String get puzzlePuzzleDashboardDescription =>
      'Тренируйтесь, анализируйте, улучшайте';
  ...
  String get puzzleNoPuzzlesToShow =>
      'Ничего нет, решите для начала несколько задач!';
  ...
  String get puzzleStrengthDescription =>
      'Вы показываете лучшие результаты в этих темах';
  ...
  String get puzzleThemeBlindSwineMate =>
      'Мат двумя ладьями по предпоследней горизонтали';
  ...
  String get puzzleThemeEndgameDescription =>
      'Тактика в последней стадии игры.';
  ...
  String get puzzleThemeMasterDescription =>
      'Задачи из партий с участием титулованных игроков.';
  ...
  String get puzzleThemeMateIn5Description =>
      'Найдите последовательность ходов, ведущую к мату.';
  ...
  String get puzzleThemeOperaMateDescription =>
      'Ладья ставит мат под защитой слона.';
  ...
  String get puzzleThemeQueenRookEndgameDescription =>
      'Эндшпиль с ферзями, ладьями и пешками.';
  ...
  String get puzzleThemeVeryLongDescription =>
      'Четыре или более ходов для победы.';
  ...
  String get settingsCancelKeepAccount =>
      'Отменить и оставить мою учётную запись';
  ...
  String get yourOpponentWantsToPlayANewGameWithYou =>
      'Соперник предлагает вам сыграть ещё раз';
  ...
  String get playFirstOpeningEndgameExplorerMove =>
      'Играть первый ход дебюта/эндшпиля';

  @override
  String get winPreventedBy50MoveRule =>
      'Не удаётся победить из-за правила 50 ходов';

  @override
  String get lossSavedBy50MoveRule =>
      'Удаётся избежать поражения из-за правила 50 ходов';
  ...
  String get lossOr50MovesByPriorMistake =>
      'Поражение или 50 ходов после последней ошибки';
  ...
  String get multipleLinesDescription =>
      'Задаёт число строк вариантов и стрелок ходов на доске';
  ...
  String get memoryDescription =>
      'Более высокие значения могут повысить производительность';
  ...
  String get youNeedAnAccountToDoThat =>
      'Вам нужно зарегистрироваться, чтобы сделать это';
  ...
  String get error_weakPassword =>
      'Этот пароль очень распространён, и его слишком легко угадать.';

  @override
  String get error_namePassword =>
      'Пожалуйста, не используйте свой логин в качестве пароля.';
  ...
  String get neverTypeYourPassword =>
      'Никогда не вводите свой пароль Lichess на другом сайте!';
  ...
  String get refreshInboxAfterFiveMinutes =>
      'Подождите 5 минут и обновите ваш почтовый ящик.';
  ...
  String get youCanHideFlair =>
      'Эта настройка скрывает все эмодзи пользователей на всём сайте.';
  ...
  String get makeAStudy =>
      'Чтобы сохранить и поделиться, рассмотрите возможность создания студии.';
  ...
  String get typePrivateNotesHere =>
      'Здесь вы можете оставить личные заметки об игре';

  @override
  String get writeAPrivateNoteAboutThisUser =>
      'Написать приватную заметку об этом пользователе';
  ...
  String get letOtherPlayersInviteYouToStudy =>
      'Разрешить другим игрокам приглашать вас в студию';
  ...
  String get error_email_unique =>
      'Адрес электронной почты недействителен или уже занят';

  @override
  String get error_email_different =>
      'Это уже и так ваш адрес электронной почты';
  ...
  String get noSimulExplanation =>
      'Этот сеанс одновременной игры не существует.';
  ...
  String get cyclePreviousOrNextVariation =>
      'Прокручивать предыдущий/следующий вариант';
  ...
  String get ifYouDoNotGetTheEmail =>
      'Если вы не получили письмо в течение 5 минут:';
  ...
  String get receiveForumNotifications =>
      'Получать уведомления при упоминании на форуме';
  ...
  String get everybodyGetsAllFeaturesForFree =>
      'Все возможности для всех бесплатно';
  ...
  String get usernameSuffixInvalid =>
      'Имя пользователя должно заканчиваться буквой или цифрой.';
  ...
  String get usernameUnacceptable =>
      'Это имя пользователя уже занято или недопустимо.';
  ...
  String get drawByFiftyMoves =>
      'Партия была сыграна вничью по правилу пятидесяти ходов.';
  ...
  String get pleasantChessExperience =>
      'Наша цель — сделать шахматы интересными для всех.';
  ...
  @override
  String get tryToWin =>
      'Попытайтесь выиграть (или хотя бы свести вничью) каждую свою партию.';
  ...
  String get agreementNice =>
      'Подтверждаю, что я буду с уважением относиться к другим игрокам.';
  ...
  String get correspondenceDesc =>
      'Игры по переписке: один или несколько дней на ход';
  ...
  String get someoneYouReportedWasBanned =>
      'Кто-то был заблокирован по вашему обращению';
  ...
  String get clickToRevealEmailAddress =>
      '[Нажмите, чтобы раскрыть адрес электронной почты]';
  ...
  String get embedsAvailable =>
      'Вставьте URL игры или ссылку на студию, чтобы встроить её.';
  ...
  String get toggleAllAnalysis =>
      'Переключить все способы компьютерного анализа';
  ...
  String get emailAssociatedToaccount =>
      'Адрес электронной почты, привязанный в этому аккаунту';
  ...
  String get youCantStartNewGame =>
      'Вы не можете начать новую игру, пока не завершена текущая.';
  ...
  String get closingAccountWithdrawAppeal =>
      'Закрытие вашей учётной записи отменит ваше обращение';
  ...
  String opponentLeftCounter(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      locale: localeName,
      other:
          'Ваш соперник покинул игру. Вы можете объявить победу через $count секунд.',
      many:
          'Ваш соперник покинул игру. Вы можете объявить победу через $count секунд.',
      few:
          'Ваш соперник покинул игру. Вы можете объявить победу через $count секунды.',
      one:
          'Ваш соперник покинул игру. Вы можете объявить победу через $count секунду.',
    );
    return '$_temp0';
  }
  ...
  String get stormYouPlayTheWhitePiecesInAllPuzzles =>
      'Вы играете белыми фигурами во всех задачах';
  ...
  String get stormSkipHelp =>
      'НОВИНКА! Вы можете пропустить один ход за гонку:';
  ...
  String get stormThisRunWasOpenedInAnotherTab =>
      'Эта серия была открыта в другой вкладке!';
  ...
  String get studyTheChapterIsTooShortToBeAnalysed =>
      'Глава слишком короткая для анализа.';
  ...
  String get studyShareChanges =>
      'Поделиться изменениями со зрителями и сохранить их на сервере';
  ...
  String get studyDeleteThisChapter =>
      'Удалить эту главу? Её нельзя будет вернуть!';
  ...
  String get studyYesKeepEveryoneOnTheSamePosition =>
      'Да: устанавливать всем одинаковую позицию';
  ...
  String get studyDeleteTheStudyChatHistory =>
      'Удалить чат студии? Восстановить будет невозможно!';
  ...
  String get studyWelcomeToLichessStudyTitle =>
      'Добро пожаловать в Студии Lichess!';
  ...
  String get studyLoadExistingLichessGameTitle =>
      'Загрузите существующую партию Lichess';
  ...
  String get studyVariantsAreSupportedTitle =>
      'Студии поддерживают варианты шахмат';
  ...
  String get studyBlackDefeatWhiteCanNotWin =>
      'Чёрные сдались, но белые не могут выиграть';

  @override
  String get studyWhiteDefeatBlackCanNotWin =>
      'Белые сдались, но чёрные не могут выиграть';
