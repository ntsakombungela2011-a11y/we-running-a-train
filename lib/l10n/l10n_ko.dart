...
class AppLocalizationsKo extends AppLocalizations {
  ...
  String get mobileCustomizeHomeTip =>
      '팁: 홈 스크린에 위젯을 추가하거나 필요없는 위젯을 삭제할 수 있습니다!';
  ...
  String get mobileOpeningExplorerNotAvailableOffline =>
      '오프닝 탐색기는 오프라인 상태에서 이용할 수 없습니다.';

  @override
  String get mobileChallengeCreated =>
      '도전이 생성되었습니다. 게임이 시작하면 알림을 받습니다.\n홈 탭에서 들어갈 수 있습니다.';
  ...
  String get variantChess960Title =>
      '백의 1랭크, 흑의 8랭크에 있는 기물의 시작 위치가 무작위로 변경됩니다.';
  ...
  String get variantCrazyhouseTitle =>
      '자신의 차례일 때, 기물을 움직이는 대신 잡았던 기물을 자신의 색으로 보드에 소환할 수 있습니다.';
  ...
  String get broadcastStandingsDisclaimer =>
      '순위는 방송된 게임을 통해 계산되며 공식 결과와는 차이가 있을 수 있습니다.';
  ...
  String get broadcastDefaultRoundNameHelp =>
      '기본 이름을 유지하면 자동으로 다른 모든 언어로 번역됩니다.';
  ...
  String get puzzleThemeCornerMateDescription =>
      '킹을 룩이나 퀸으로 구석에 가두고, 나이트로 체크메이트를 가합니다.';
  ...
  String get puzzleThemeEpauletteMateDescription =>
      '체크된 킹의 두 인접한 탈출로가 다른 기물에 의해 막혀 있습니다.';
  ...
  String get puzzleThemePillsburysMateDescription =>
      '비숍이 킹을 가두어두는 동안 룩을 이용해 메이트를 합니다.';
  ...
  String get puzzleThemeMorphysMateDescription =>
      '룩으로 킹의 퇴로를 차단하고, 비숍으로 킹에게 체크합니다.';
  ...
  String get puzzleThemeSwallowstailMateDescription =>
      'V자 모양인 제비의 꼬리를 시각적으로 닮은 체크메이트 패턴입니다.';
  ...
  String get permanentLinkForAnyoneToChallengeYou =>
      '누구나 동일한 설정으로 당신에게 도전할 수 있는 영구적인 링크입니다.';
  ...
  String get dtzWithRounding =>
      '다음 포획, 폰 이동 혹은 체크메이트까지 남은 반수를 반올림 후 나타낸 DTZ50\" 수치';
  ...
  String get threadsDescription =>
      '이 값을 CPU 스레드 수보다 낮게 설정하세요. 안전하고 적절한 값을 표시해 두었습니다';
  ...
  String get signupEmailPromise =>
      '저희는 귀하의 계정에 대한 이메일만을 전송할 것이며 귀하의 이메일을 공유하지 않을 것입니다.';
