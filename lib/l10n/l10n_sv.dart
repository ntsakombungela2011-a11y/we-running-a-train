...
class AppLocalizationsSv extends AppLocalizations {
  ...
  String get variantChess960Title =>
      'Pjäspositioner på bakre raden är slumpade.';
  ...
  String get variantKingOfTheHillTitle =>
      'Ta din kung till centrum för att vinna spelet.';
  ...
  String get variantThreeCheckTitle =>
      'Schacka din motståndare 3 gånger för att vinna.';
  ...
  String get variantAtomicTitle =>
      'Spräng din motståndares kung för att vinna spelet.';
  ...
  String get variantRacingKingsTitle =>
      'Få din kung till andra sidan av brädet för att vinna.';
  ...
  String opponentLeftCounter(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      locale: localeName,
      other:
          'Motståndaren lämnade partiet. Du kan kräva seger om $count sekunder.',
      one:
