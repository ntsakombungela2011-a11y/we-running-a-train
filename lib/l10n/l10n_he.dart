...
class AppLocalizationsHe extends AppLocalizations {
  ...
  String get mobilePuzzleStormFilterNothingToShow =>
      'אין מה להראות. ניתן לשנות את חתכי הסינון';
  ...
  String get mobilePuzzleStreakAbortWarning =>
      'הרצף הנוכחי שלך ייאבד אך הניקוד יישמר.';
  ...
  String activityRankedInTournament(
    ...
    String _temp0 = intl.Intl.pluralLogic(
      ...
      locale: localeName,
      other:
          'סיים/ה במקום #$count (אחוזון %$param2) עם $param3 משחקים ב$param4',
  ...
  String get arenaArenaStreaksHelp =>
      'לאחר 2 ניצחונות, ניצחונות רצופים מקנים 4 נקודות במקום 2.';
  ...
  String arenaDrawingWithinNbMoves(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      locale: localeName,
      other:
          'סיום המשחק בתיקו במהלך $count התורות הראשונים לא יניב נקודות עבור אף שחקן.',
      many:
          'סיום המשחק בתיקו במהלך $count התורות הראשונים לא יניב נקודות עבור אף שחקן.',
      two:
          'סיום המשחק בתיקו במהלך $count התורות הראשונים לא יניב נקודות עבור אף שחקן.',
  ...
  String get broadcastTheNewRoundHelp =>
      'הסבב החדש יכלול את אותם התורמים והחברים כמו בסבב הקודם.';
  ...
  String get broadcastDefinitivelyDeleteRound =>
      'מחיקת הסבב הזה והמשחקים שבו לצמיתות';
  ...
  String get challengeRegisterToSendChallenges =>
      'אנא הירשמו כדי לשלוח הזמנות למשחקים.';
  ...
  String get challengeDeclineLater =>
      'זה לא הזמן המתאים עבורי, אנא שאל שוב מאוחר יותר.';
  ...
  String get challengeDeclineTimeControl =>
      'אני לא מאשר/ת אתגרים בקטגוריית הזמן הזו.';
  ...
  String get challengeDeclineCasual =>
      'בבקשה שלח לי הזמנה למשחק לא מדורג במקום.';

  @override
  String get challengeDeclineStandard =>
      'אני לא מקבל/ת עכשיו הזמנות למשחקי שחמט לא סטנדרטי.';

  @override
  String get challengeDeclineVariant =>
      'אני לא מעוניין לשחק את סוג השחמט הזה עכשיו.';
  ...
  String get challengeInviteLichessUser =>
      'ניתן גם לשלוח הזמנה למשתמש/ת Lichess:';
  ...
  String get coordinatesYouHaveThirtySeconds =>
      'יש לך 30 שניות למקם נכונה כמה שיותר משבצות!';
  ...
  String get preferencesBoardHighlights =>
      'הדגשת המשבצות בלוח: המהלך האחרון ושח';

  @override
  String get preferencesPieceDestinations =>
      'יעדי הכלים: מהלכים וקדם-מהלכים מותרים';
  ...
  String get preferencesExplainShowPlayerRatings =>
      'אפשרות זו מסתירה את כל הדירוגים מ־Lichess, כדי לסייע לך להתרכז במשחק. משחקים עם דירוג עדיין ישפיעו על הדירוג שלך, אפשרות זו רק מציגה או מסתירה אותו.';
  ...
  String get preferencesHorizontalGreenProgressBars =>
      'שורות התקדמות ירוקות אופקיות';

  @override
  String get preferencesSoundWhenTimeGetsCritical =>
      'השמעת צליל כאשר הזמן עומד להיגמר';
  ...
  String get preferencesTakebacksWithOpponentApproval =>
      'החזרת המהלך האחרון: מותנה בהסכמת היריב';
  ...
  String get preferencesNotifyPush =>
      'התראה למכשיר גם כשאינך מחובר/ת ל־Lichess';
  ...
  String get puzzleFindTheBestMoveForBlack =>
      'מצא/י את המהלך הטוב ביותר לשחור.';
  ...
  String get puzzleOpeningsYouPlayedTheMost =>
      'הפתיחות הנפוצות שלך במשחקים מדורגים';
  ...
  String get puzzleNoPuzzlesToShow =>
      'אין מה להראות, לכו לפתור כמה חידות קודם!';

  @override
  String get puzzleImprovementAreasDescription =>
      'התאמנו על אלה כדי לשפר את ההתקדמות שלכם!';
  ...
  String get puzzleThemeArabianMateDescription =>
      'פרש וצריח לוכדים יחד את המלך היריב בפינת הלוח.';
  ...
  String get puzzleThemeEndgameDescription =>
      'טקטיקה במהלך השלב האחרון של המשחק.';
  ...
  String get puzzleThemeForkDescription =>
      'מסע בו הכלי הנע מאיים על שני כלי יריב במקביל.';
  ...
  String get puzzleThemeMiddlegameDescription =>
      'טקטיקה במהלך השלב השני של המשחק.';
  ...
  String get puzzleThemeOpeningDescription =>
      'טקטיקה במהלך השלב הראשון של המשחק.';
  ...
  String get puzzleThemePromotionDescription =>
      'הכתרת אחד מהרגלים למלכה או לכלי משני.';
  ...
  String get puzzleThemeQueenRookEndgameDescription =>
      'סיום עם מלכות, צריחים ורגלים בלבד.';
  ...
  String get puzzleThemeQueensideAttackDescription =>
      'תקיפת המלך של היריב, לאחר שהצריח לצד המלכה.';
  ...
  String get puzzleThemeSuperGMDescription =>
      'פאזלים ממשחקים של השחקנים הטובים בעולם.';
  ...
  String get settingsManagedAccountCannotBeClosed =>
      'חשבונך מנוהל, ולכן לא ניתן לסגור אותו.';
  ...
  String get toInviteSomeoneToPlayGiveThisUrl =>
      'כדי להזמין מישהו לשחק, שתפו את הכתובת הזאת';
  ...
  String get orLetYourOpponentScanQrCode =>
      'אפשר גם לתת ליריב לסרוק את קוד ה־QR הזה';
  ...
  String get maybeIncludeMoreGamesFromThePreferencesMenu =>
      'להוסיף עוד משחקים מתפריט ההגדרות?';
  ...
  String get winOr50MovesByPriorMistake =>
      'ניצחון או כלל 50 המסעים בגלל טעות קודמת';

  @override
  String get lossOr50MovesByPriorMistake =>
      'הפסד או כלל 50 המסעים בגלל טעות קודמת';
  ...
  String get neverTypeYourPassword =>
      'לעולם אל תקלידו את סיסמתכם ב־Lichess באף אתר אחר!';
  ...
  String get usernameCanBeUsedForNewAccount =>
      'תוכל/י ליצור חשבון חדש עם שם המשתמש הזה';
  ...
  String get refreshInboxAfterFiveMinutes =>
      'חכו 5 דקות ולאחר מכן בצעו ריענון לתיבת המייל.';
  ...
  String get thisAccountViolatedTos =>
      'החשבון הזה הפר את תנאי השימוש של Lichess';
  ...
  String get yourOpponentProposesATakeback =>
      'יריבך מציע/ה להחזיר את המהלך האחרון';
  ...
  String get inappropriateNameWarning =>
      'כל דבר לא הולם ולו במעט עלול לגרום לסגירת חשבונך.';

  @override
  String get emptyTournamentName =>
      'יש להשאיר ריק בשביל לקרוא לטורניר על שם שחקני שחמט דגולים.';

  @override
  String get makePrivateTournament =>
      'הפכו את הטורניר לפרטי, והגבילו את הכניסה עם סיסמה';
  ...
  String get youCanHideFlair =>
      'ישנה הגדרה שמאפשרת להסתיר את כל הסמלילים באתר.';
  ...
  String get bewareTheGameIsRatedButHasNoClock =>
      'שימו לב! המשחק מדורג אך אין שעון.';
  ...
  String get reportProcessedFasterInEnglish =>
      'הדיווח שלך יטופל מהר יותר אם ייכתב באנגלית.';

  @override
  String get error_provideOneCheatedGameLink =>
      'בבקשה לספק לפחות קישור אחד למשחק עם רמאות.';
  ...
  String get writeAPrivateNoteAboutThisUser =>
      'כתבו הערה פרטית בנוגע למשתמש הזה';
  ...
  String get letOtherPlayersChallengeYou =>
      'אפשרו לשחקנים אחרים להזמינכם למשחק';

  @override
  String get letOtherPlayersInviteYouToStudy =>
      'אפשרו לשחקנים אחרים להזמין אתכם ללוחות למידה';
  ...
  String get error_email_acceptable =>
      'כתובת דוא״ל זו אינה קבילה. אנא בדקו אותה בשנית ונסו שוב.';
  ...
  String get signUpToHostOrJoinASimul =>
      'הירשמו כדי לארח משחקים סימולטניים או להשתתף בהם';
  ...
  String get aboutSimul =>
      'משחק סימולטני מערב שחקן יחיד אשר משחק נגד שחקנים רבים בו זמנית.';
  ...
  String get whenCreateSimul =>
      'כאשר יוצרים משחק סימולטני, זוכים לשחק עם שחקנים רבים בו זמנית.';

  @override
  String get simulVariantsHint =>
      'אם ייבחרו מספר נגזרות שחמט, כל שחקן יריב יזכה לבחור באיזו לשחק.';
  ...
  String get simulHostExtraTimePerPlayer =>
      'זמן נוסף למארח/ת עבור כל שחקן שמצטרף';
  ...
  String get variationArrowsInfo =>
      'החיצים בנגזרות השחמט מאפשרים ניווט קל ללא צורך ברשימת המסעים.';
  ...
  String get tournamentHomeTitle =>
      'טורנירים של שחמט הכוללים מגבלות זמן ונגזרות שחמט מגוונות';
  ...
  String get checkAllEmailFolders =>
      'בדקו את כל תיקיות הספאם, דואר הזבל וכיוצא בזה';
  ...
  String get youCanAlsoScrollOverTheBoardToMoveInTheGame =>
      'ניתן גם לגלול כדי להתקדם במשחק.';
  ...
  String get letOtherPlayersMessageYou =>
      'אפשר/י לשחקנים אחרים לשלוח לך הודעות';

  @override
  String get receiveForumNotifications =>
      'קבלת התראות כאשר המשתמש שלי מתויג בפורום';
  ...
  String get usernameAlreadyUsed =>
      'שם המשתמש הזה כבר קיים, אנא נסו שם משתמש אחר.';
  ...
  String get pleasantChessExperience =>
      'אנחנו מנסים לספק חווית שח נעימה לכולם.';

  @override
  String get goodPractice =>
      'בעקבות זאת, אנחנו חייבים לוודא שכל השחקנים ינהגו בכבוד.';

  @override
  String get potentialProblem =>
      'כאשר בעיה מסויימת מתגלה, אנו מציגים הודעה זו.';
  ...
  String get agreementNice =>
      'אני מסכים/ה תמיד להיות אדיב/ה כלפי השחקנים האחרים.';
  ...
  String get thisTopicIsArchived =>
      'נושא זה עבר לארכיון ולא ניתן עוד להשיב עליו.';
  ...
  String get youCannotPostYetPlaySomeGames =>
      'אתה עדיין לא יכול לפרסם בפורום זה. שחק כמה משחקים!';
  ...
  String get lichessDbExplanation =>
      'משחקים מדורגים אשר נדגמו מכלל שחקני Lichess';
  ...
  String get stormYouPlayTheWhitePiecesInAllPuzzles =>
      'את/ה משחק/ת בלבן בכל החידות';

  @override
  String get stormYouPlayTheBlackPiecesInAllPuzzles =>
      'את/ה משחק/ת בשחור בכל החידות';
  ...
  String get studyAnnotateWithGlyphs =>
      'השתמשו בסימנים מוסכמים כדי להגיב על מהלכים';

  @override
  String get studyTheChapterIsTooShortToBeAnalysed =>
      'פרק זה קצר מכדי להצדיק ניתוח.';
  ...
  String get studyOnlyPublicStudiesCanBeEmbedded =>
      'ניתן להטמיע אך ורק לוחות למידה פומביים!';
  ...
  String get studyClearAllCommentsInThisChapter =>
      'ניקוי כל ההערות, הרישומים והציורים בפרק זה';
  ...
  String get studyWelcomeToLichessStudyTitle =>
      'ברוכים הבאים ללוחות הלמידה של Lichess!';
  ...
  String get studyBlackDefeatWhiteCanNotWin =>
      'השחור הובס, אבל הלבן אינו יכול לנצח';

  @override
  String get studyWhiteDefeatBlackCanNotWin =>
      'הלבן הובס, אבל השחור אינו יכול לנצח';
