...
final userProvider = FutureProvider.autoDispose.family<User, UserId>((
  Ref ref,
  UserId id,
) {
...
final userPerfStatsProvider = FutureProvider.autoDispose
    .family<UserPerfStats, (UserId, Perf)>((Ref ref, (UserId, Perf) params) {
      return ref
          .read(userRepositoryProvider)
          .getPerfStats(params.$1, params.$2);
    }, name: 'UserPerfStatsProvider');

final liveStreamersProvider = FutureProvider.autoDispose<IList<Streamer>>((
  Ref ref,
) {
...
final autoCompleteUserProvider = FutureProvider.autoDispose
    .family<IList<LightUser>, String>((Ref ref, String term) async {
...
typedef CrosstableProviderParams = ({
  UserId userId1,
  UserId userId2,
  bool matchup,
});

final crosstableProvider = FutureProvider.autoDispose
    .family<Crosstable, CrosstableProviderParams>((
      Ref ref,
