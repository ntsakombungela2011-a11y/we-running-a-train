...
class AppLocalizationsFa extends AppLocalizations {
  ...
  String get mobileAccountPreferencesHelp =>
      'این ترجیح‌ها به حساب Lichess تان اعمال می‌شود و در همه دستگاه‌ها استفاده خواهد شد.';
  ...
  String get mobileNotAllFeaturesAreAvailable =>
      'لطفاً توجه کنید که همه آرَنگ‌های بَرکِ قدیمی یا وبگاه اکنون در دسترس نیستند، اما ما همواره در حال افزودنِ آرَنگ‌هاییم.';
  ...
  String get mobilePuzzleStormConfirmEndRun =>
      'می‌خواهید این دور را پایان دهید؟';
  ...
  String get mobilePuzzleStormNothingToShow =>
      'چیزی برای نمایش نیست، چند دور معماباران بازی کنید.';

  @override
  String get mobilePuzzleStormSubtitle =>
      'در ۳ دقیقه، هر چندتا معما که می‌توانید، حل کنید.';
  ...
  String get mobileSettingsImmersiveModeSubtitle =>
      'رابط کاربری سامانه را هنگام بازی بپنهانید. اگر از ایماهای ناوِش سامانه در لبه‌های پرده آزرده می‌شوید، از این گزینه بَهرید. برای پرده‌های بازی و معما اعمال می‌شود.';
  ...
  String get mobileSettingsPickAnImageSwipeToDisplay =>
      'برای نمایش پس‌زمینه‌های دیگر، انگشت بکشید';
  ...
  String get mobileCustomizeHomeTip =>
      'نکته: می‌توانید ابزارک‌های بیشتری به صفحهٔ خانه بیفزایید یا آنهایی را که نیاز ندارید بحذفید!';
  ...
  String get mobileOpeningExplorerNotAvailableOffline =>
      'پویشگرِ گشایش، برون‌خط امکان‌پذیر نیست.';
  ...
  String get variantChess960Title =>
      'وضعیتِ آغازشِ مُهره‌های عرضِ سواران تصادفی است.';
  ...
  String get variantKingOfTheHillTitle =>
      'برای پیروزی در بازی، شاه‌تان را به تپه بَرید.';
  ...
  String get variantThreeCheckTitle =>
      'برای پیروزی در بازی، ۳ بار به حریف‌تان کیش دهید.';
  ...
  String get variantHordeTitle =>
      'یک طرف پیاده‌های زیادی دارد و دیگری یک ارتشِ عادی دارد.';
  ...
  String get variantRacingKingsTitle =>
      'برای پیروزی، شاه‌تان را به طرفِ دیگر بَرید.';
  ...
  String get arenaIsRated =>
      'این مسابقات رسمی است و بر درجه‌بندی‌تان اثر می‌گذارد.';

  @override
  String get arenaIsNotRated =>
      'این مسابقات رسمی *نیست* و بر درجه‌بندی‌تان اثر *نمی‌گذارد*.';

  @override
  String get arenaSomeRated =>
      'برخی مسابقات رسمی‌اَند و بر درجه‌بندی‌تان اثر می‌گذارند.';
  ...
  String get arenaHowIsTheWinnerDecidedAnswer =>
      'وقتی مهلت مسابقات تمام شود، بازیکنی که بیشترین امتیاز را کسبیده باشد، برنده اعلام می‌شود.\n\nاگر دو یا چند بازیکن از نظر امتیاز مساوی باشند، عملکردِ مسابقاتی، معیارِ یِرشکن است.';
  ...
  String get arenaArenaStreaksHelp =>
      'پس از دو بُرد، بُردهای پَیاپی به‌جای ۲، ۴ امتیاز می‌دهد.';
  ...
  String arenaDrawingWithinNbMoves(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      locale: localeName,
      other:
          'در صورت تساوی بازی در $count حرکت اول، به هیچکدام از بازیکنان امتیازی نخواهد رسید.',
      one:
          'در صورت تساوی بازی در $count حرکت اول، به هیچکدام از بازیکنان امتیازی نخواهد رسید.',
    );
    return '$_temp0';
  ...
  String get broadcastSourceGameIds =>
      'تا ۶۴ شناسهٔ بازی Lichess، جداشده با فاصله.';
  ...
  String get broadcastStartDateHelp =>
      'اختیاری است، اگر می‌دانید چه زمانی رویداد شروع می‌شود';
  ...
  String get broadcastDefinitivelyDeleteRound =>
      'این دور و همه بازی‌هایش را به طور کامل حذف کن.';
  ...
  String get broadcastShowScores =>
      'نمایش امتیاز بازیکنان بر پایه نتیجه بازی‌ها';

  @override
  String get broadcastReplacePlayerTags =>
      'اختیاری: عوض کردن نام، درجه‌بندی و عنوان بازیکنان';
  ...
  @override
  String get broadcastRegulations => 'آیین‌نامه';
  ...
  String get broadcastStandingsDisclaimer =>
      'رده‌بندی با استفاده از بازی‌های پخش‌شده محاسبه می‌شود و ممکن است با نتایج رسمی متفاوت باشد.';
  ...
  @override
  String get broadcastMatchPoints => 'امتیازِ رویارویی';

  @override
  String get broadcastGamePoints => 'امتیاز بازی';

  @override
  String get broadcastMatches => 'رویارویی';

  @override
  String get broadcastMatchHistory => 'تاریخچهٔ رویارویی';
  ...
  String broadcastTermsAutomaticallyTranslated(String param) {
    return 'اصطلاح(های) زیر، خودکار ترجمه خواهند شد: $param.';
  }
  ...
  @override
  String get broadcastTiebreaks => 'یِرشکن';
  ...
  String get challengeDeclineTimeControl =>
      'من با این زمان‌بندی، پیشنهاد بازی را نمی‌پذیرم.';
  ...
  String get challengeDeclineStandard =>
      'اکنون پیشنهاد بازی‌های وَرتا را نمی‌پذیرم.';

  @override
  String get challengeDeclineVariant =>
      'اکنون مایل نیستم این وَرتا را بازی کنم.';

  @override
  String get challengeDeclineNoBot =>
      'من پیشنهاد بازی از ربات‌ها را نمی‌پذیرم.';

  @override
  String get challengeDeclineOnlyBot =>
      'من فقط پیشنهاد بازی از ربات‌ها را می‌پذیرم.';
  ...
  String get coordinatesPracticeOnlySomeFilesAndRanks =>
      'تمرین فقط روی ستون‌ها و ردیف‌های مشخص';
  ...
  String get preferencesPieceDestinations =>
      'مقصد مهره(حرکت معتبر و پیش حرکت )';
  ...
  String get preferencesDisplayBoardResizeHandle =>
      'نمایش دستگیرهٔ تغییر اندازهٔ تخته';
  ...
  String get preferencesHowDoYouMovePieces =>
      'تمایل دارید که چگونه مهره ها را حرکت دهید؟';
  ...
  String get preferencesSnapArrowsToValidMoves =>
      'چسبیدن پیکان‌ها به حرکت‌های ممکن';
  ...
  String get preferencesScrollOnTheBoardToReplayMoves =>
      'برای بازپخش حرکت‌ها، روی تخته بِنَوَردید';
  ...
  String get preferencesNotifyPush =>
      'اعلان اَفزاره، هنگامی که در Lichess نیستید';
  ...
  String get puzzleUseCtrlF =>
      'از Ctrl+f برای یابیدن گشایش دلخواه‌تان استفاده کنید!';
  ...
  String get puzzleLookupOfPlayer =>
      'به دنبال معماهای برگرفته از بازی‌های یک بازیکن مشخص، بگردید';
  ...
  String get puzzleNoPuzzlesToShow =>
      'چیزی برای نمایش نیست، نخست بروید و چند معما حل کنید!';

  @override
  String get puzzleImprovementAreasDescription =>
      'برای بهینیدن پیشرفت‌تان، این‌ها را بیاموزید!';

  @override
  String get puzzleStrengthDescription =>
      'شما در این زمینه‌ها بهترین عملکرد را دارید';
  ...
  String get puzzleThemeBishopEndgameDescription =>
      'آخربازی، تنها با فیل‌ها و پیاده‌ها.';
  ...
  String get puzzleThemeCollinearMoveDescription =>
      'دو مهرهٔ مخالف با همدیگر رودررو می‌شوند و یکی بدون گرفتن مهرهٔ حریف، در امتداد خط حمله حرکت می‌کند.';
  ...
  String get puzzleThemeDiscoveredCheckDescription =>
      'حرکتِ یک مهره، کیشِ مهاجمِ پنهان-ی را فاش می‌کند که اغلب به مزیتی قاطع مُنجَر می‌شود.';
  ...
  String get puzzleThemeEnPassantDescription =>
      'گرفتن پیاده در حال عبور با پیاده دیگر.';
  ...
  String get puzzleThemeEpauletteMateDescription =>
      'دو خانهٔ فرارِ مجاورِ شاهِ تحتِ کیش، با مهره‌های دیگر اشغال شده‌اند.';
  ...
  String get puzzleThemeSwallowstailMateDescription =>
      'الگوی ماتی که ظاهرش شبیهِ دُمِ پرستو یا عدد ۷ است.';
  ...
  String get puzzleThemeKnightEndgameDescription =>
      'آخربازی، تنها با اسب‌ها و پیاده‌ها.';
  ...
  String get puzzleThemeMasterDescription =>
      'معماهای برگرفته از بازی‌های بازیکنان عنوان‌دار.';
  ...
  String get puzzleThemeOneMoveDescription =>
      'یک معما که فقط یک حرکت طول می‌کشد.';
  ...
  String get puzzleThemeQueenEndgameDescription =>
      'آخربازی، تنها با وزیرها و پیاده‌ها.';
  ...
  String get puzzleThemeRookEndgameDescription =>
      'آخربازی، تنها با رخ‌ها و پیاده‌ها.';
  ...
  String get puzzleThemeSuperGMDescription =>
      'معماهای برگرفته از بازی‌های بهترین بازیکنان جهان.';
  ...
  String get settingsManagedAccountCannotBeClosed =>
      'حساب‌تان مدیریت می‌شود و نمی‌توان آن را بست.';
  ...
  String get settingsCloseAccountAreYouSure =>
      'آیا از بستن حساب کابری خود مطمئن هستید؟';
  ...
  String get toInviteSomeoneToPlayGiveThisUrl =>
      'برای دعوت کسی به بازی، این وب‌نشانی را دهید';
  ...
  String get orLetYourOpponentScanQrCode =>
      'یا از حریف‌تان بخواهید این رمزینه را بِپویَد';

  @override
  String get reusableChallengeUrl => 'وب‌نشانیِ پایای چالش';
  ...
  String minRatingX(String param) {
    return 'کمینهٔ درجه‌بندیِ $param';
  }

  @override
  String maxRatingX(String param) {
    return 'بیشینهٔ درجه‌بندیِ $param';
  }
  ...
  String get playFirstOpeningEndgameExplorerMove =>
      'نخستین حرکت گشایش/آخربازی پویشگر را برو';
  ...
  String get multipleLinesDescription =>
      'تعیینِ تعداد شاخه‌های ارزیابی و پیکان‌های حرکت روی تخته';

  @override
  String get searchTime => 'مدت جستجو';

  @override
  String get searchTimeDescription => 'تعیینِ مدت برای ارزیابی وضعیت‌های تازه';
  ...
  String get threadsDescription =>
      'این را زیرِ تعداد رشته‌های «واو.په.میم» (CPU) تان تعیین کنید، هفتک‌ها انتخابی خوب و امن را نشان می‌دهند';

  @override
  String get threadsDescriptionMobile =>
      'رشته‌های بیشتر، باتریِ بیشتر برای تحلیلِ بهتر می‌مصرفند';
  ...
  String get memoryDescription =>
      'مقدارهای بالاتر ممکن است عملکرد را بهبود بخشد';
  ...
  String get removesTheDepthLimit =>
      'محدودیت عمق را برمی‌دارد و رایانه‌تان داغ می‌ماند';
  ...
  String get error_namePassword =>
      'خواهشانه از نام کاربری‌تان برای گذرواژه‌تان استفاده نکنید.';

  @override
  String get blankedPassword =>
      'شما از گذرواژهٔ یکسانی در وبگاه دیگری بهریده‌اید و آن وبگاه به خطر افتاده است. برای اطمینان از ایمنی حساب Lichessتان، به شما نیاز داریم تا گذرواژهٔ نویی را تعیین کنید. از درک‌تان سپاسگزاریم.';
  ...
  String get neverTypeYourPassword =>
      'هرگز گذرواژهٔ Lichessتان را در وبگاه دیگری ننویسید!';
  ...
  String get emailConfirmNotReceived =>
      'آیا رایانامهٔ تاییدتان را پس از نام‌نویسی دریافت نکردید؟';

  @override
  String get whatSignupUsername =>
      'از چه نام کاربری برای ثبت نام استفاده کردید؟';
  ...
  String get refreshInboxAfterFiveMinutes =>
      '۵ دقیقه بصبرید و صندوق رایانامه‌تان را تازه کنید.';
  ...
  String get accountConfirmationEmailNotNeeded =>
      'به رایانامهٔ تایید نیاز ندارید.';
  ...
  String get yourOpponentProposesATakeback =>
      'حریف‌تان پیشنهاد «برگرداندن» می‌دهد';
  ...
  @override
  String get captcha_fail => 'لطفا «آجرا»یِ شطرنج را حل کنید';
  ...
  String get emptyTournamentName =>
      'برای نامیدن مسابقات به نام یک شطرنج‌باز برجسته، خالی بگذارید.';

  @override
  String get makePrivateTournament =>
      'خصوصی کردن مسابقات و دسترسی تنها با گذرواژه';
  ...
  @override
  String get randomChess960Position => 'وضعیتِ کاتورهٔ شطرنج۹۶۰';
  ...
  String get youCanHideFlair =>
      'تنظیماتی برای مخفی کردن همه شکلک‌های کاربر در کل ویگاه وجود دارد.';
  ...
  String get makeAStudy =>
      'برای نگهداری مطمئن و همرسانی، ساخت یک مطالعه را در نظر بگیرید.';
  ...
  String get automaticallyProceedToNextGameAfterMoving =>
      'پس از حرکت، خودکار به بازی بعدی روید';
  ...
  String get error_provideOneCheatedGameLink =>
      'لطفآ حداقل یک نمونه تقلب در بازی را مطرح کنید.';
  ...
  String get writeAPrivateNoteAboutThisUser =>
      'یک یادداشت خصوصی درباره این کاربر بنویسید';
  ...
  @override
  String get clearField => 'پاکیدنِ میدان';

  @override
  String get orSeparator => 'یا';
  ...
  String get letOtherPlayersFollowYou =>
      'اجازه دهید دیگر بازیکنان شما را بدنبالند';

  @override
  String get letOtherPlayersChallengeYou =>
      'اجازه دهید بازیکنان دیگر به شما پیشنهاد بازی دهند';

  @override
  String get letOtherPlayersInviteYouToStudy =>
      'بگذارید دیگر بازیکنان، شما را به مطالعه دعوت کنند';
  ...
  String get allInformationIsPublicAndOptional =>
      'تمامی اطلاعات عمومی و اختیاری است.';
  ...
  String get error_email_unique =>
      'نشانیِ رایانامه نامعتبر یا قبلاً گرفته شده است';
  ...
  String get aboutSimul =>
      'نمایش هم زمان، بازی هم زمان یک نفر با چندین حریف است.';

  @override
  String get aboutSimulImage =>
      'از ۵۰ بازی فیشر موفق به کسب ۴۷ برد و ۲ تساوی و یک باخت شد.';
  ...
  String get tournamentHomeTitle =>
      'مسابقات شطرنج با وَرتاها و زمان‌بندی‌های گوناگون';
  ...
  String get checkAllEmailFolders =>
      'پوشه‌های بُنجُل (junk)، هرزنامه (spam) و دیگر را بررسید';
  ...
  String get timeToProcessAMoveOnLichessServer =>
      'زمانِ پردازش یک حرکت در کارسازِ Lichess';
  ...
  String get youCanAlsoScrollOverTheBoardToMoveInTheGame =>
      'برای حرکت، روی تختهٔ بازی بِنَوَردید.';
  ...
  String get receiveForumNotifications =>
      'دریافت اعلان هنگام نام‌بَری در انجمن';
  ...
  String get everybodyGetsAllFeaturesForFree =>
      'همگی از مزایا بصورت رایگان استفاده می کنند';
  ...
  String get usernameSuffixInvalid =>
      'نام کاربری باید با حرف یا شماره خاتمه یابد.';
  ...
  String get showUnreadLichessMessage =>
      'شما یک پیام خصوصی از Lichess دریافت کرده‌اید.';
  ...
  String get pleasantChessExperience =>
      'هدف ما مهیا ساختن تجربه لذت بخش شطرنج به همه افراد است.';
  ...
  String get potentialProblem =>
      'زمانی که مشکلی احتمالی شناسایی شد ، این پیام را نمایش می دهیم.';
  ...
  String get resignLostGames =>
      'بازی های از دست رفته را انصراف دهید(نگذارید زمان تمام شود).';

  @override
  String get temporaryInconvenience =>
      'ما برای این مشکل موقت عذرخواهی می کنیم،';

  @override
  String get wishYouGreatGames =>
      'و برای شما بازیهای عالی در lichess.org آرزو می کنیم.';
  ...
  String get agreementNice =>
      'می‌پذیرم که همواره به بازیکنان دیگر احترام گزارم.';
  ...
  String get correspondenceDesc =>
      'بازی های مکاتبه ای : یک  یا چند روز برای هر حرکت';
  ...
  @override
  String get pleaseBeNiceInTheForum => 'لطفا در انجمن خوش‌رفتار باشید.';

  @override
  String get thisTopicIsArchived =>
      'این موضوع بایگانی شده است و دیگر نمی توان به آن پاسخ داد.';
  ...
  String get clickToRevealEmailAddress =>
      '[برای آشکارسازی نشانیِ رایانامه بتِلیکید]';
  ...
  String get tournDescriptionHelp =>
      'نکته خاصی را می‌خواهید به شرکت‌گران گویید؟ بکوشید کوتاه باشد. پیوندهای فرونشان موجودند:\n[name](https://url)';
  ...
  String get simulHostcolor =>
      'رنگ مربوط به نمایش‌دهنده یا میزبان برای هر بازی';
  ...
  String get simulDescriptionHelp =>
      'آیا می‌خواهید مطلبی را به شرکت‌کنندگان بگویید؟';
  ...
  String get sentEmailWithLink =>
      'ما رایانامه‌ای شامل یک پیوند را به شما فرستاده‌ایم.';
  ...
  String get lichessPatronInfo =>
      'وبگاهِ Lichess خیریه است و نرم‌افزار متن‌بازِ تمام‌رایگانی است. همهٔ هزینه‌های عملیات، توسعه و محتوا تنها از راهِ داشَن‌های کاربران تأمین می‌شود.';
  ...
  String thereAreNoResultsForX(String param) {
    return 'برای «$param» نتیجه‌ای یافت نشد';
  }
  ...
  String opponentLeftCounter(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      locale: localeName,
      other:
          'رقیب شما بازی را ترک کرده است. شما میتوانید بعد از $count ثانیه اعلام پیروزی کنید.',
      one:
          'رقیب شما بازی را ترک کرده است. شما میتوانید بعد از $count ثانیه اعلام پیروزی کنید.',
    );
    return '$_temp0';
  ...
  String get studyShareChanges =>
      'هم‌رسانی تغییرها با تماشاگران و ذخیره‌شان در کارساز';
  ...
  String get studyReadMoreAboutEmbedding =>
      'درباره قرار دادن (در سایت) بیشتر بخوانید';
  ...
  String get studyYesKeepEveryoneOnTheSamePosition =>
      'بله: همه را در وضعیت یکسانی نگه دار';

  @override
  String get studyNoLetPeopleBrowseFreely =>
      'خیر: به مردم اجازه جستجوی آزادانه بده';
  ...
  String get studyDeleteTheStudyChatHistory =>
      'پیشینه گپِ مطالعه پاک شود؟ بازگشت وجود ندارد!';
  ...
  String get studyWhereDoYouWantToStudyThat =>
      'کجا می‌خواهید آنرا مطالعه کنید؟';
  ...
  String get studyCustomPositionText =>
      'صفحه را به روش خود بچینید. مناسب برای بررسی آخر بازی‌ها.';

  @override
  String get studyLoadExistingLichessGameTitle =>
      'بازی قبلی در لیچس را بارگذاری کن';
  ...
  String get studyVariantsAreSupportedTitle =>
      'مطالعه‌ها از واریانت‌ها پشتیبانی می‌کنند';
  ...
  String get studyBlackDefeatWhiteCanNotWin =>
      'سیاه باخت، اما سفید نمی‌تواند ببرد';

  @override
  String get studyWhiteDefeatBlackCanNotWin =>
      'سفید باخت، اما سیاه نمی‌تواند ببرد';
