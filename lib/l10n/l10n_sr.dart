...
class AppLocalizationsSr extends AppLocalizations {
  ...
  String get preferencesBoardHighlights =>
      'Истицања на табли (последњи потез и шах)';

  @override
  String get preferencesPieceDestinations =>
      'Дестинације фигура (важећи потези и предпотези)';
  ...
  String get preferencesDisplayBoardResizeHandle =>
      'Прикажи ручицу за промену величине табле';
  ...
  String get preferencesTakebacksWithOpponentApproval =>
      'Враћања потеза (са одобрењем противника)';
  ...
  String get preferencesConfirmResignationAndDrawOffers =>
      'Потврди предају и понуду за реми';
  ...
  String get puzzleThemeCastlingDescription =>
      'Доведи краља на сигурно и развиј топа за напад.';
  ...
  String get puzzleThemeEndgameDescription =>
      'Тактика током последње фазе партије.';
  ...
  String get thisAccountViolatedTos =>
      'Овај налог је прекршио Lichess Услове коришћења Услуге';
  ...
  String get makePrivateTournament =>
      'Направи турнир приватним и ограничи приступ са лозинком';
  ...
  String get simulClockHint =>
      'Што више играча играш, више времена ти може бити потребно.';
  ...
  String get correspondenceDesc =>
      'Дописне партије: један или неколико дана по потезу';
  ...
  String get thisTopicIsArchived =>
      'Ова тема је архивирана и не може се више одговарати на њу.';
