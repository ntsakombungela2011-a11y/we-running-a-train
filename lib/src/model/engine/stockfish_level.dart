...
enum StockfishLevel {
  level1(
    skill: -12,
    multiPv: 10,
    searchTime: Duration(milliseconds: 500),
    threads: 1,
  ),
  level2(
    skill: -6,
  ...
  level3(
    skill: 0,
    multiPv: 6,
    searchTime: Duration(milliseconds: 610),
    threads: 1,
  ),
  level4(
    skill: 4,
    multiPv: 5,
    searchTime: Duration(milliseconds: 765),
    threads: 1,
  ),
  level5(
    skill: 7,
    multiPv: 5,
    searchTime: Duration(milliseconds: 920),
    threads: 1,
  ),
  level6(
    skill: 9,
    multiPv: 4,
    searchTime: Duration(milliseconds: 1075),
    threads: 2,
  ),
  level7(
    skill: 11,
    multiPv: 4,
    searchTime: Duration(milliseconds: 1225),
    threads: 2,
  ),
  level8(
    skill: 13,
    multiPv: 4,
    searchTime: Duration(milliseconds: 1380),
    threads: 2,
  ),
  level9(
    skill: 15,
    multiPv: 4,
    searchTime: Duration(milliseconds: 1535),
    threads: 2,
  ),
  level10(
    skill: 17,
    multiPv: 4,
    searchTime: Duration(milliseconds: 1690),
    threads: 2,
  ),
  level11(
    skill: 19,
    multiPv: 4,
    searchTime: Duration(milliseconds: 1845),
    threads: 2,
  ),
  level12(
    skill: 20,
    multiPv: 4,
    searchTime: Duration(milliseconds: 2000),
    threads: 2,
  );
