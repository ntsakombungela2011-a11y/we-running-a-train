...
class AppLocalizationsKk extends AppLocalizations {
  ...
  String get mobileAccountPreferencesHelp =>
      'Осы баптаулар Личес тіркелгіңізде сақталып, барлық құрылғыңызға таралады.';
  ...
  String get mobileNotAllFeaturesAreAvailable =>
      'Ескерту! Сайт пен бұрыңғы қолданбадағы мүмкіндіктер толық енгізіліп бітпеген. Енгізу жұмыстарын тоқтаусыз жасап жатырмыз.';
  ...
  String get mobilePuzzleStormFilterNothingToShow =>
      'Сәйкестік жоқ, сүзгіні өзгертіп көріңіз';

  @override
  String get mobilePuzzleStormNothingToShow =>
      'Нәтиже әзір жоқ. Жұмбақ Дауылын ойнап көріңіз.';

  @override
  String get mobilePuzzleStormSubtitle =>
      '3 минутта барынша көп жұмбақ шешіп көр.';

  @override
  String get mobilePuzzleStreakAbortWarning =>
      'Қазіргі тізбектен айрыласыз, нәтиже сақталады.';
  ...
  String get mobileSettingsImmersiveModeSubtitle =>
      'Ойын кезінде жүйенің UI жасыру. Телефонның шолу батырмалары мазаңызды алып тұрса, бұл пайдалы болар. Әсері ойын мен жұмбақ кезінде шығады.';

  @override
  String get mobileSettingsMaterialDifferenceCapturedPieces =>
      'Басып алынған тастар';
  ...
  String get mobileSettingsPickAnImageHelp =>
      'Артқы суретті қою үшін қарағы кейіп орнатылсын. Суреттің күнгірт болғаны дұрыс.';
  ...
  String get mobileSettingsPickAnImageSwipeToDisplay =>
      'Басқа артқы кескін шығару үшін сырғытыңыз';
  ...
  String get mobileSettingsShapeDrawingSubtitle =>
      'Пішінді екі саусақпен салыңыз: бір саусақты бос шаршыға қойып, екінші саусақпен сырғып пішін салыңыз.';
  ...
  String get mobileSettingsTouchFeedbackSubtitle =>
      'Қосулы болса, жүріс не басып алудан кейін құрылғыңыз діріл етеді.';
  ...
  String get mobileCustomizeHomeTip =>
      'Кеңес: Қосымша виджет қосу не артығын алып тастауыңызға болады!';
  ...
  String get mobileOpeningExplorerNotAvailableOffline =>
      'Желіден тыс кезде Бастамалар Қоры ашылмайды.';

  @override
  String get mobileChallengeCreated =>
      'Шақыру құрылды: Ойын басталғанда хабар келеді.\nОйынға басты беттен кіре алатын боласыз.';
  ...
  String get mobileGoodMoveButThereIsBetter =>
      'Жақсы жүріс, бірақ одан да жақсысы бар';
  ...
  String activityRankedInTournament(
    ...
    String _temp0 = intl.Intl.pluralLogic(
      ...
      locale: localeName,
      other:
          '$param4 $param3 ойын нәтижесінде $count-ші орында ($param2% үздік)',
  ...
  String get arenaIsRated =>
      'Бұл бағаланатын жарыс, сіздің рейтингіңізге әсер етеді.';

  @override
  String get arenaIsNotRated =>
      'Бұл жарыс бағалы *емес*, сіздің рейтингіңізге әсер *етпейді*.';

  @override
  String get arenaSomeRated =>
      'Жарыстардың кейбірі бағалы, яғни рейтингке әсер етеді.';
  ...
  String arenaDrawingWithinNbMoves(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      locale: localeName,
      other:
          'Ойынның алғашқы $count жүрісінде тепе-теңдік ешбір ойыншыға ұпай әкелмейді.',
      one:
          'Ойынның алғашқы $count жүрісінде тепе-теңдік ешбір ойыншыға ұпай әкелмейді.',
    );
    return '$_temp0';
  ...
  String get broadcastHowToUseLichessBroadcasts =>
      'Личес Көрсетілімді қолдану жолы.';
  ...
  String get broadcastDefinitivelyDeleteRound =>
      'Айналым мен оның ойындарын толығымен жою.';
  ...
  String get challengeDeclineLater =>
      'Қазір мен үшін ыңғайлы кез емес, кейін сұрап көріңіз.';
  ...
  String get coordinatesGoAsLongAsYouWant =>
      'Асықпай жүрсеңіз болады, уақытта шектеу жоқ!';
  ...
  String get preferencesBoardHighlights =>
      'Жүріс ізін көрсету (кейінгі жүріс пен шах)';

  @override
  String get preferencesPieceDestinations =>
      'Тастың бағытын көрсету (заңды, алдын-ала жүрістер)';
  ...
  String get preferencesMoveListWhilePlaying =>
      'Ойын кезіндегі жүрістер тізімі';
  ...
  String get preferencesCorrespondenceAndUnlimited =>
      'Хат-хабарлы мен уақыты шексіз';

  @override
  String get preferencesConfirmResignationAndDrawOffers =>
      'Берілу мен тепе-теңдік ұсынысын растау';
  ...
  String get preferencesNotifyTimeAlarm =>
      'Хат-хабарлы ойын уақыты бітер алдында';
  ...
  String get preferencesNotifyPush =>
      'Құрылғының ескертуі, Личестен тыс кезіңізде';
  ...
  String get puzzleFindTheBestMoveForWhite =>
      'Ақтың ең ұтымды жүрісін табыңыз.';

  @override
  String get puzzleFindTheBestMoveForBlack =>
      'Қараның ең ұтымды жүрісін табыңыз.';
  ...
  String get puzzleOpeningsYouPlayedTheMost =>
      'Сіздің бағалы ойындарыңызда ең жиі келетін бастама';
  ...
  String get puzzleNoPuzzlesToShow =>
      'Мәлімет жоқ. Алдымен жұмбақ шешіп көріңіз!';
  ...
  String get puzzleThemeBackRankMateDescription =>
      'Өз сабында өз тастарымен қамалған патшаға мат.';
  ...
  String get puzzleThemeBishopEndgameDescription =>
      'Пілдер мен сарбаздары ғана бар ойынсоңы.';
  ...
  String get puzzleThemeEndgameDescription =>
      'Ойынның соңғы кезеңіндегі тактика.';
  ...
  String get puzzleThemeForkDescription =>
      'Қарсыластың бірден екі тасын ұратын тас жүрісі.';
  ...
  String get puzzleThemeKnightEndgameDescription =>
      'Аттар мен сарбаздары ғана бар ойынсоңы.';
  ...
  String get puzzleThemeMasterDescription =>
      'Атақты ойыншылардың ойындарынан алынған жұмбақтар.';
  ...
  String get puzzleThemeMateIn5Description =>
      'Матқа жеткізетін жүрістер тізбегін табыңыз.';
  ...
  String get puzzleThemeMiddlegameDescription =>
      'Ойынның екінші кезеңіндегі тактика.';
  ...
  String get puzzleThemeOneMoveDescription =>
      'Бір жүріспен ғана шешілетін жұмбақ.';
  ...
  String get puzzleThemeOpeningDescription =>
      'Ойынның алғашқы кезеңіндегі тактика.';
  ...
  String get puzzleThemeQueenEndgameDescription =>
      'Уәзірлер мен сарбаздары ғана бар ойынсоңы.';
  ...
  String get puzzleThemeRookEndgameDescription =>
      'Туралар мен сарбаздары ғана бар ойынсоңы.';
  ...
  String get puzzleThemeVeryLongDescription =>
      'Жеңіске төрт не одан да көп қадам.';
  ...
  String get orLetYourOpponentScanQrCode =>
      'Не болмаса, қарсылас осы QR кодты скандаушы болсын';
  ...
  String get yourOpponentWantsToPlayANewGameWithYou =>
      'Қарсылас сізбен тағы ойнағысы келеді';
  ...
  String get playFirstOpeningEndgameExplorerMove =>
      'Бастама/ойынсоңы қорының бірінші жүрісін жасау';

  @override
  String get winPreventedBy50MoveRule =>
      '50 жүрістік ережемен жеңіске жеткізбеу';
  ...
  String get removesTheDepthLimit =>
      'Тереңдік шектеулерін жояды, әрі компьютеріңізді қыздырады';
  ...
  String get error_weakPassword =>
      'Осындай құпиясөз қолданыста көп, оны табу оңайға соғады.';

  @override
  String get error_namePassword =>
      'Құпиясөз ретінде өз тіркеулі атыңызды жазбаңыз.';
  ...
  String get neverTypeYourPassword =>
      'Личестегі құпиясөзіңізді басқа сайттарда қолданбаңыз!';
  ...
  String get emailConfirmNotReceived =>
      'Тіркелуден кейін поштаңызға растау хаты келмеді ме?';
  ...
  String get refreshInboxAfterFiveMinutes =>
      '5 минут күтіп, поштаңыздың бетін жаңартып көріңіз.';
  ...
  String get thisAccountViolatedTos =>
      'Бұл тіркелгі Личес-тің Қызмет көрсету шартын бұзды';
  ...
  String get yourOpponentProposesATakeback =>
      'Қарсылас жүріс қайтаруды сұрап тұр';
  ...
  String get clickOnTheBoardToMakeYourMove =>
      'Тақтада жүріс жасаумен адам екеніңізді растаңыз.';
  ...
  String get emptyTournamentName =>
      'Елеулі бір шахматшының атымен атау үшін бос қалдырыңыз.';

  @override
  String get makePrivateTournament =>
      'Кіруді құпиясөзбен шектеп, жарысты оңашалаңыз';
  ...
  String get youCanHideFlair =>
      'Керек десеңіз, бүкіл ойыншылардың Кейпін жасыру амалы бар.';
  ...
  String get makeAStudy =>
      'Ұзаққа сақтау әрі бөлісу үшін зерттеуді жасаған дұрыс.';
  ...
  String get automaticallyProceedToNextGameAfterMoving =>
      'Жүрістен кейін келесі ойынға бірден өту';
  ...
  String get error_provideOneCheatedGameLink =>
      'Кемі бір ойынның сілтемесін беруіңізді сұраймыз.';
  ...
  String get writeAPrivateNoteAboutThisUser =>
      'Бұл ойыншы туралы жеке жазба жазу';
  ...
  String get letOtherPlayersChallengeYou =>
      'Ойыншылар сізді ойынға шақыра ала ма?';

  @override
  String get letOtherPlayersInviteYouToStudy =>
      'Ойыншылар сізді зерттеуге шақыра ала ма?';
  ...
  String get signUpToHostOrJoinASimul =>
      'Қалың ойынды бастау не қосылу үшін тіркеліңіз';
  ...
  String get aboutSimul =>
      'Қалың ойында ойыншы бір мезгілде бірнешеуге қарсы ойнайды.';
  ...
  String get simulHostExtraTimePerPlayer =>
      'Әр ойыншы үшін бас ойыншыға берілетін қосымша уақыт';
  ...
  String get checkAllEmailFolders =>
      'Спам, себет, басқа да қалталарды қарап шығыңыз';
  ...
  String get networkLagBetweenYouAndLichess =>
      'Личес пен сіздің араңыздағы кідіріс';
  ...
  String get letOtherPlayersMessageYou =>
      'Ойыншыларға сізге хабар жіберу рұқсат па?';

  @override
  String get receiveForumNotifications =>
      'Форумда сіз туралы жазса, хабарлама алу';
  ...
  String get everybodyGetsAllFeaturesForFree =>
      'Барлық құралдары барлық адам үшін тегін';
  ...
  String get usernameAlreadyUsed =>
      'Бұл ат қолданыста, басқасын жазып көріңіз.';
  ...
  String get drawByFiftyMoves =>
      '\"50 жүріс\" ережесіне сәйкес ойын тепе-теңдікпен аяқталды.';
  ...
  String get findBetterMoveForBlack =>
      'Қара пайдасына ең тиімді жүрісті табыңыз';
  ...
  String get tryAnotherMoveForBlack =>
      'Қаралар пайдасына басқаша жүріп көріңіз';
  ...
  String get pleasantChessExperience =>
      'Біз әрбіреудің ойны жайлы өтуін мақсат етеміз.';

  @override
  String get goodPractice =>
      'Сол үшін барлық ойыншылардың тәртібін қадағалауға тура келеді.';

  @override
  String get potentialProblem =>
      'Күдікті жағдай анықталса, осы хабарлама шығады.';
  ...
  String get resignLostGames =>
      'Ойын нашар жүріп жатса, беріліңіз (уақыттың аяқталуын күтпеңіз).';

  @override
  String get temporaryInconvenience =>
      'Осы уақытша жайсыздық үшін біз өкінішімізді білдіріп,';
  ...
  String get agreementNice =>
      'Мен басқа ойыншыларға құрметпен қараймын деп уәде беремін.';
  ...
  String get correspondenceDesc =>
      'Хат-хабарлы ойындар: әр жүріске бір не бірнеше күн';
  ...
  String get thisTopicIsArchived =>
      'Бұл тақырып мұрағатталды, енді жауап жазуға болмайды.';
  ...
  String get youCannotPostYetPlaySomeGames =>
      'Сіз форумда әлі хабар қалдыра алмайсыз. Ойнаңыз!';
  ...
  String get someoneYouReportedWasBanned =>
      'Сіздің шағымыңыздан кейін біреу бұғауланды';
  ...
  String get lostAgainstTOSViolator =>
      'Сіз Личестің Ережесін бұзған біреуге жеңілдіңіз';
  ...
  String get embedsAvailable =>
      'Еңгізу үшін ойынның не зерттеу бөлімінің URL-ын қойыңыз.';
  ...
  String get youCantStartNewGame =>
      'Бұл ойын аяқталмағанша, сіз жаңа ойын бастай алмайсыз.';
  ...
  String get closingAccountWithdrawAppeal =>
      'Тіркелгі жабылса, қарсы шағымдарыңыз жойылады';
  ...
  String opponentLeftCounter(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      ...
      locale: localeName,
      other:
          'Қарсылас ойыннан шықты. Сіз $count секундтан кейін жеңісті талап ете аласыз.',
      one:
          'Қарсылас ойыннан шықты. Сіз $count секундтан кейін жеңісті талап ете аласыз.',
    );
    return '$_temp0';
  ...
  String get stormYouPlayTheWhitePiecesInAllPuzzles =>
      'Барлық жұмбақтарда сіз ақ түспен ойнайсыз';
  ...
  String get stormWaitingForMorePlayers =>
      'Көбірек ойыншылардың қосылуын күтеміз...';
  ...
  String get stormSkipHelp =>
      'Сіз әр бәйгеде бір жүрістен ғана бас тарта аласыз:';
  ...
  String get studyTheChapterIsTooShortToBeAnalysed =>
      'Бөлім талдауға жарамды болу үшін тым қысқа.';
  ...
  String get studyOnlyPublicStudiesCanBeEmbedded =>
      'Тек жалпыға ашық зерттеулер енгізуге жарамды!';
  ...
  String get studyYesKeepEveryoneOnTheSamePosition =>
      'Иә: бәрі бірдей күйде болады';

  @override
  String get studyNoLetPeopleBrowseFreely =>
      'Жоқ: бәріне еркін шолуға рұқсат ету';
