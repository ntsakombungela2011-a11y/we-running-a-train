...
final Map<String, List<_BotFen>> _botFens = {
  'leelaknightodds': [
    ...
    _BotFen(
      fen: 'rnbqkb1r/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w KQkq',
      side: Side.white,
    ),
    _BotFen(
  ...
  'leelapieceodds': [
    ...
    _BotFen(
      fen: 'rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/1NB1KBNR w Kkq',
      side: Side.black,
    ),
    _BotFen(
      fen: 'rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/R1B1KB1R w KQkq',
      side: Side.black,
    ),
    _BotFen(
