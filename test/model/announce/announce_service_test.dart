...
class _NotificationDisplayMock extends Mock
...
void main() {
  ...
  test(
    'auto-cancels the notification when the countdown date is reached',
    () async {
      final container = await makeContainer(
        overrides: {
          notificationDisplayProvider: notificationDisplayProvider
  ...
  test(
    'does not show a notification when the announce date is already in the past',
    () async {
      final container = await makeContainer(
        overrides: {
          notificationDisplayProvider: notificationDisplayProvider
  ...
  test(
    'cancels the notification when the user taps the dismiss action',
    () async {
      final container = await makeContainer(
        overrides: {
          notificationDisplayProvider: notificationDisplayProvider
